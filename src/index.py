...
# import xmltodict # use this iff we can't get lxml working as intended
...
class Indexer(object):
                    ...
                    for k, v in element.attrib.iteritems():
                        if k != "doc":
                            ...
                            if attribute != None and element.text != None:
                                print (attribute + ": " + element.text.strip()).encode("utf-8")
    ...
    def write_files(self):
        ...
        pickle.dump(self.doc_lengths, open(os.path.join("bin/", "doc_lengths.txt"), "wb"))
        pickle.dump(self.stopwords, open(os.path.join("bin/", "stopwords.txt"), "wb"))
